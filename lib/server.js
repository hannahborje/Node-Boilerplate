...
server.get('/friend', checkAuth, function(req, res) {
    ...
    // Är requesten korrekt skriven?
    // Isf finns användarnamnet i URL:en, annars undefined
    // Kolla upp om användarnamnet existerar
    mongo.find(friend, function(exists){
        friendExists = exists;
        ...
        // Skicka tillbaka om parametrar saknas eller är ogiltiga
        } else { dash(req, res); }
    });
});
